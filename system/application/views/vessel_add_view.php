...
<ul class="section">
  ...
  <li><?php echo form_label('HO dimensions', 'HO_dims') . form_input('HO_dims', set_value('HO_dims')); ?></li>
  <li><?php echo form_label('HA', 'HA') . form_input('HA', set_value('HA')); ?></li>
  <li><?php echo form_label('HA dimensions', 'HA_dims') . form_input('HA_dims', set_value('HA_dims')); ?></li>
...
<ul class="section">
  ...
  <li><?php echo form_label('IFO sea ballast', 'IFO_sea_ball') . form_input('IFO_sea_ball', set_value('IFO_sea_ball')); ?></li>
  <li><?php echo form_label('IFO sea laden', 'IFO_sea_laden') . form_input('IFO_sea_laden', set_value('IFO_sea_laden')); ?></li>
  <li><?php echo form_label('MDO sea ballast', 'MDO_sea_ball') . form_input('MDO_sea_ball', set_value('MDO_sea_ball')); ?></li>
  <li><?php echo form_label('MDO sea laden', 'MDO_sea_laden') . form_input('MDO_sea_laden', set_value('MDO_sea_laden'));?></li>
  <li><?php echo form_label('MDO port', 'MDO_port') . form_input('MDO_port', set_value('MDO_port')); ?></li>
  <li><?php echo form_label('IFO port', 'IFO_port') . form_input('IFO_port', set_value('IFO_port')); ?></li>
  ...
  <li><?php echo form_label('Manager', 'Managers') . form_dropdown('Managers', $ddmanager, '', 'class="dd-list"'); ?></li>
  <li><?php echo form_label('Homeport', 'Cities') . form_dropdown('Cities', $ddcity, '', 'class="dd-list"'); ?></li> 
  <li><?php echo form_label('Flag', 'Countries') . form_dropdown('Countries', $ddcountry, '', 'class="dd-list"'); ?></li>
</ul>
<?php echo form_close(); ?>
